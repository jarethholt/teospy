...
* :mod:`~teospy.flu1` provides the Helmholtz free energy of fluid water.
* :mod:`~teospy.flu2` provides thermodynamic properties that can be derived
  directly from the Helmholtz free energy in the primary variables.
* :mod:`~teospy.flu3a` provides the Gibbs free energy of liquid water and water
  vapour separately, with temperature and pressure as variables.
* :mod:`~teospy.flu3b` provides other properties of liquid water and water
  vapour using temperature and pressure as variables.
* The level 5 modules provide formulations of fluid water properties based on
  Gibbs energy functions for each phase. :mod:`~teospy.flu5_if97` provides
  Gibbs energy functions for both phases, whereas :mod:`~teospy.liq5_f03`
  provides functions for the liquid phase only.


``flu1``
--------

.. automodule:: teospy.flu1
