...
def genflu2():
    ...
    funs = [flu2.cp,flu2.cv,flu2.enthalpy,flu2.entropy,flu2.expansion,
        flu2.gibbsenergy,flu2.internalenergy,flu2.kappas,flu2.kappat,
...
def genflu3b():
    ...
    funs = [flu3b.liq_cp,flu3b.liq_cv,flu3b.liq_enthalpy,flu3b.liq_entropy,
        ...
        flu3b.liq_kappas,flu3b.liq_kappat,flu3b.liq_lapserate,
    ...
    fnames = ['cp','cv','enthalpy','entropy','expansion','gibbsenergy',
        'internalenergy','kappas','kappat','lapserate','soundspeed']
    argfmt = '({0:3g},{1:3g})'
    ...
    funs = [flu3b.vap_cp,flu3b.vap_cv,flu3b.vap_enthalpy,flu3b.vap_entropy,
        ...
        flu3b.vap_kappas,flu3b.vap_kappat,flu3b.vap_lapserate,
...
def genliq5():
    ...
    funs = [liq5_f03.cp,liq5_f03.density,liq5_f03.expansion,liq5_f03.kappat,
        liq5_f03.soundspeed]
    fargs = args1
    refs = [4180.64286060,996.556352243,0.274804919056e-3,0.450510795725e-9,
        1501.52808421]
    fnames = ['cp','density','expansion','kappat','soundspeed']
    argfmt = '({0:3g},{1:3g})'
